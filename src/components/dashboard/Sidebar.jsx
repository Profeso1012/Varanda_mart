...
const SELLER_NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Payments & Payouts', path: '/payments'  },
    ],
  },
  {
    group: 'Ads & Marketing',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Inventory',                       path: '/supplier/inventory' },
      { label: 'Dropship Orders Received',        path: '/supplier/orders'   },
      { label: 'Supplier Earnings & Withdrawals', path: '/supplier/earnings' },
    ],
  },
];
