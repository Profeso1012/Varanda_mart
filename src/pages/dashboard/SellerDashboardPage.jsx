              ...
              {QUICK_ACCESS.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-3 p-4 rounded-xl border border-gray-100 hover:border-green-200 hover:bg-green-50 transition-all text-left group"
                  >
                    {/* Icon circle */}
                    <div className="w-9 h-9 rounded-lg bg-green-50 flex items-center justify-center shrink-0 group-hover:bg-green-100 transition-colors">
                      <Icon size={18} className="text-[#22925B]" />
                    </div>
                    <div className="min-w-0">
                      ...
                      <p className="text-[12px] text-[#5C5D86] mt-0.5 leading-tight">
                        {item.desc}
                      </p>
                    </div>
                  </button>
