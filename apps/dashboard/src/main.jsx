      ...
      <AuthProvider>
        <Routes>
          ...
          <Route path="/orders" element={
            <SellerRoute><OrdersPage /></SellerRoute>
          } />
          <Route path="/orders/:id" element={
            <SellerRoute><OrderDetailPage /></SellerRoute>
          } />
          ...
          <Route path="/settings/shipping" element={
            <SellerRoute><ShippingSettingsPage /></SellerRoute>
          } />
          ...
          <Route path="/bundles" element={
            <SellerRoute><BundlesPage /></SellerRoute>
          } />
          <Route path="/discounts" element={
            <SellerRoute><DiscountsPage /></SellerRoute>
          } />
