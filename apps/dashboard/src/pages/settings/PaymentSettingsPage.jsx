...
export default function PaymentSettingsPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await sellerApi.delete('/business/bank-account');
      setBankAccount(null);
      setShowDeleteConfirm(false);
      setSuccess(true);
      setTimeout(() => setSuccess(false), 3000);
    } catch (err) {
      setError(err.response?.data?.error?.message || 'Failed to delete bank account');
    } finally {
      setDeleting(false);
    }
  };
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '14px', color: '#6B7280', marginBottom: '20px' }}>
              This will remove your bank account from the system. You won't be able to receive payouts until you add a new account.
            </p>
