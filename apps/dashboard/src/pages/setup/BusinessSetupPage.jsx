...
function StepIndicator({ current, isSupplier }) {
  ...
  return (
    <div className="flex items-start justify-center gap-0 mb-6 sm:mb-8 px-2 sm:px-0">
      {steps.map((label, i) => {
        const stepNum  = i + 1;
        ...
        return (
          <div key={label} className="flex items-start">
            <div className="flex flex-col items-center">
              ...
              <p className={`text-[10px] sm:text-xs mt-1 text-center max-w-[60px] sm:max-w-[70px] leading-tight ${
            ...
            {i < steps.length - 1 && (
              <div className="h-px w-8 sm:w-16 bg-gray-200 mt-3 sm:mt-4 mx-0.5 sm:mx-1 shrink-0" />
            )}
          </div>
        );
      })}
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-300 via-gray-200 to-green-100 flex flex-col">
      ...
      <div className="flex-1 flex items-start justify-center px-4 pb-12">
        <div className="w-full max-w-140 bg-white rounded-2xl shadow-sm px-4 sm:px-10 py-6 sm:py-8">
