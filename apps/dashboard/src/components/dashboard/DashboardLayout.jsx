        ...
        <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="relative text-[#1F2A30]">
              <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="w-4 h-4 sm:w-5 sm:h-5">
            ...
            {logoUrl ? (
              ...
              <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#22925B] flex items-center justify-center text-white text-xs font-bold">
                {userInitials}
              </div>
            )}
          </div>
